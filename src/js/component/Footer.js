		...
		<>
			<footer className="footer mt-auto py-3 bg-light">
				<div className="container align-items-center">
					<div className="row">
						<div className="col-6 col-lg-4 col-md-4 col-sm-4 align-self-center">
							<span>
								<h4>Contactanos...</h4>
							</span>
								...
								<div className="modal-content">
									<div className="modal-header">
										<h5 className="modal-title" id="staticBackdropLabel">
											<strong>Entra al siguiente link y envíanos un correo para ayudarte</strong>
										</h5>
										<button
											type="button"
											className="btn-close"
									...
									<div className="modal-body">
										<a href="mailto:arismendiaaron@gmail.com?Subject=Ayuda%20al%20cliente%20">
